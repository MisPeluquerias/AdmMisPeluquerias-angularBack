...
router.get('/getAllCities', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    db_1.default.query(query, [search, search, search, search, search, offset, pageSize], (error, results) => {
        if (error) {
