    ...
    connection.query(query, async (error, results) => {
      ...
      try {
        ...
        worksheet.columns = [
          ...
          // Desbloquear columnas específicas (ejemplo: las columnas 'name' y 'address' serán editables)
          worksheet.getColumn('name').eachCell((cell) => {
          ...
          worksheet.getColumn('email').eachCell((cell) => {
            cell.protection = { locked: false };
          });
